...
public class q1 {
    public static void main(String[] args) {
        ...
        for (int i=0;in;i++) crops[i]=in.nextLine().trim();
        ...
        System.out.println(replant(crops_mat, 0, 0, n, m, 0, nm, crop_types));
    }
